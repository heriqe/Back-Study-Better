...
@app.route('/quizzes/<int:quiz_id>/questoes', methods=['GET'])
...
@app.route('/questoes/<int:questao_id>/responder', methods=['POST'])
...
@app.route('/horarios/<int:id_usuario>', methods=['GET'])
